...
(1, 1, TIMESTAMP(CURRENT_DATE() + INTERVAL 5 DAY, '09:00:00'), TIMESTAMP(CURRENT_DATE() + INTERVAL 5 DAY, '09:00:00')),
(2, 2, TIMESTAMP(CURRENT_DATE() - INTERVAL 30 DAY, '10:00:00'), TIMESTAMP(CURRENT_DATE() - INTERVAL 30 DAY, '10:00:00')),
(3, 3, TIMESTAMP(CURRENT_DATE() - INTERVAL 3 DAY, '11:00:00'), TIMESTAMP(CURRENT_DATE() - INTERVAL 1 DAY, '20:10:00')),
(4, 4, TIMESTAMP(CURRENT_DATE() - INTERVAL 5 DAY, '10:00:00'), TIMESTAMP(CURRENT_DATE() - INTERVAL 1 DAY, '18:30:00')),
(5, 5, TIMESTAMP(CURRENT_DATE() - INTERVAL 15 DAY, '08:00:00'), TIMESTAMP(CURRENT_DATE() - INTERVAL 15 DAY, '08:00:00')),
(6, 6, TIMESTAMP(CURRENT_DATE() + INTERVAL 4 DAY, '12:00:00'), TIMESTAMP(CURRENT_DATE() + INTERVAL 4 DAY, '12:00:00')),
(7, 7, TIMESTAMP(CURRENT_DATE() - INTERVAL 25 DAY, '14:00:00'), TIMESTAMP(CURRENT_DATE() - INTERVAL 25 DAY, '14:00:00')),
(8, 8, TIMESTAMP(CURRENT_DATE() - INTERVAL 3 DAY, '14:30:00'), TIMESTAMP(CURRENT_DATE() - INTERVAL 1 DAY, '09:00:00')),
(9, 9, TIMESTAMP(CURRENT_DATE() - INTERVAL 5 DAY, '09:15:00'), TIMESTAMP(CURRENT_DATE() - INTERVAL 1 DAY, '16:45:00')),
(10, 10, TIMESTAMP(CURRENT_DATE() - INTERVAL 20 DAY, '11:00:00'), TIMESTAMP(CURRENT_DATE() - INTERVAL 20 DAY, '11:00:00')),
(11, 11, TIMESTAMP(CURRENT_DATE() - INTERVAL 25 DAY, '16:00:00'), TIMESTAMP(CURRENT_DATE() - INTERVAL 25 DAY, '16:00:00'));

INSERT INTO chat_participant (room_id, user_id, last_read_at, joined_at) VALUES
(1, 2, TIMESTAMP(CURRENT_DATE() + INTERVAL 5 DAY, '09:00:00'), TIMESTAMP(CURRENT_DATE() + INTERVAL 5 DAY, '09:00:00')),
(1, 1, TIMESTAMP(CURRENT_DATE() + INTERVAL 5 DAY, '09:05:00'), TIMESTAMP(CURRENT_DATE() + INTERVAL 5 DAY, '09:05:00')),
(2, 2, TIMESTAMP(CURRENT_DATE() - INTERVAL 30 DAY, '10:00:00'), TIMESTAMP(CURRENT_DATE() - INTERVAL 30 DAY, '10:00:00')),
(2, 1, TIMESTAMP(CURRENT_DATE() - INTERVAL 30 DAY, '10:02:00'), TIMESTAMP(CURRENT_DATE() - INTERVAL 30 DAY, '10:02:00')),
...
(4, 1, TIMESTAMP(CURRENT_DATE() - INTERVAL 1 DAY, '15:30:00'), TIMESTAMP(CURRENT_DATE() - INTERVAL 5 DAY, '10:00:00')),
(4, 2, TIMESTAMP(CURRENT_DATE() - INTERVAL 1 DAY, '15:30:00'), TIMESTAMP(CURRENT_DATE() - INTERVAL 5 DAY, '10:05:00')),
(5, 2, TIMESTAMP(CURRENT_DATE() - INTERVAL 15 DAY, '08:00:00'), TIMESTAMP(CURRENT_DATE() - INTERVAL 15 DAY, '08:00:00')),
(5, 1, TIMESTAMP(CURRENT_DATE() - INTERVAL 15 DAY, '08:01:00'), TIMESTAMP(CURRENT_DATE() - INTERVAL 15 DAY, '08:01:00')),
(6, 1, TIMESTAMP(CURRENT_DATE() + INTERVAL 4 DAY, '12:00:00'), TIMESTAMP(CURRENT_DATE() + INTERVAL 4 DAY, '12:00:00')),
(6, 2, TIMESTAMP(CURRENT_DATE() + INTERVAL 4 DAY, '12:03:00'), TIMESTAMP(CURRENT_DATE() + INTERVAL 4 DAY, '12:03:00')),
(7, 1, TIMESTAMP(CURRENT_DATE() - INTERVAL 25 DAY, '14:00:00'), TIMESTAMP(CURRENT_DATE() - INTERVAL 25 DAY, '14:00:00')),
(7, 2, TIMESTAMP(CURRENT_DATE() - INTERVAL 25 DAY, '14:05:00'), TIMESTAMP(CURRENT_DATE() - INTERVAL 25 DAY, '14:05:00')),
...
(10, 1, TIMESTAMP(CURRENT_DATE() - INTERVAL 20 DAY, '11:00:00'), TIMESTAMP(CURRENT_DATE() - INTERVAL 20 DAY, '11:00:00')),
(10, 2, TIMESTAMP(CURRENT_DATE() - INTERVAL 20 DAY, '11:04:00'), TIMESTAMP(CURRENT_DATE() - INTERVAL 20 DAY, '11:04:00')),
(11, 1, TIMESTAMP(CURRENT_DATE() - INTERVAL 25 DAY, '16:00:00'), TIMESTAMP(CURRENT_DATE() - INTERVAL 25 DAY, '16:00:00')),
(11, 2, TIMESTAMP(CURRENT_DATE() - INTERVAL 25 DAY, '16:02:00'), TIMESTAMP(CURRENT_DATE() - INTERVAL 25 DAY, '16:02:00'));
